...
import { FlowchartSection } from '@/components/landing/flowchart-section'
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="relative">
        {/* Decorative Elements */}
        <div className="absolute top-20 right-10 w-2 h-2 bg-primary rounded-full animate-pulse" />
        <div className="absolute top-40 left-10 w-2 h-2 bg-accent rounded-full animate-pulse animation-delay-1000" />
        <div className="absolute bottom-40 right-20 w-2 h-2 bg-secondary rounded-full animate-pulse animation-delay-2000" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#" className="hover:text-primary transition-colors">Blind Assistance</a></li>
                <li><a href="#" className="hover:text-primary transition-colors">Deaf Assistance</a></li>
                <li><a href="#" className="hover:text-primary transition-colors">Speech Assistance</a></li>
